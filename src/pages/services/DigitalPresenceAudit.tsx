...
export default function DigitalPresenceAudit() {
  ...
  const props = {
    ...
    problem: "Symptoms are easy to see: low traffic, poor conversion, or a brand that feels outdated. But treating symptoms doesn't fix the underlying system. The audit identifies structural, strategic, and messaging gaps that may be weakening trust and conversion.",
    ...
    outcome: "A clear, actionable roadmap detailing what needs to change, why it matters commercially, and what steps to take first.",
    relatedLinks: [
