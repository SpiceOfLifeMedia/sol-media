...
export default function BrandSystems() {
  useSeo('Brand Systems', 'Build a brand people recognise, understand and trust.');

  const props = {
    title: "Brand Systems",
    tagline: "Build a brand people recognise, understand and trust.",
    problem: "The business has moved forward, but its identity still signals an earlier stage. An inconsistent visual identity and unclear messaging confuse prospects, dilute your perceived value, and make it harder to justify premium pricing.",
    ...
    process: [
      { num: '01', title: 'Positioning', desc: 'We define exactly who you are, who you serve, and the distinct angle that sets you apart.' },
      ...
      { num: '03', title: 'System Handover', desc: 'We deliver comprehensive guidelines and templates so your team can apply the brand perfectly every time.' }
    ],
    outcome: "A coherent, premium identity and message that operates consistently across every platform, building immediate trust with your ideal clients.",
    relatedLinks: [
