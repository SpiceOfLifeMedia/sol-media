...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 py-7 md:py-9">
        <Reveal delay={0.15}>
      ...
      <div
        aria-hidden="true"
        className="hidden md:flex absolute left-6 md:left-12 bottom-8 flex-col items-center gap-3 pointer-events-none z-10"
