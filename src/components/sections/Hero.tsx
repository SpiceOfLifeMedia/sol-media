...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="md:grid md:grid-cols-[1fr_42%] md:min-h-[82dvh]">

        {/* ── Left column: text content ── */}
        <div className="relative flex flex-col justify-start pt-[100px] md:pt-[108px]">

          {/* Subtle vertical accent line */}
          <div
            aria-hidden="true"
            className="hidden md:block absolute right-0 top-24 bottom-0 w-px pointer-events-none"
            style={{
              background:
          ...
          <div className="container relative z-10 mx-auto px-6 md:px-12 pb-8 md:pb-12">
            ...
            <Reveal delay={0.05} overflow="visible">
              <h1 className="font-serif font-medium text-foreground tracking-[-0.03em] leading-[1.02] text-[clamp(2.25rem,7vw,5.5rem)] max-w-[900px] pb-3 md:pb-4">
        ...
        >
          ...
          />
          {/* Gradient blends left edge into background colour */}
