...
export const SEO_ROUTES: Record<string, SeoConfig> = {
  ...
  '/work/petiola-wilson': {
    title: 'Petiola Wilson Website Design Case Study | SOL Media',
    description:
      'See how Spice of Life Media designed and built Petiola Wilson’s responsive cultural services website and structured organisational enquiry experience.',
    index: true,
    pageType: 'WebPage',
    socialImage: {
      url: `${SITE_URL}/assets/work/petiola-wilson-desktop.webp`,
      alt: 'Petiola Wilson cultural speaker and educator website designed by Spice of Life Media',
      type: 'image/webp',
      width: 1512,
      height: 900,
    },
...
export function structuredDataForPath(pathname: string) {
  ...
  const workNames: Record<string, string> = {
    ...
    '/work/petiola-wilson': 'Petiola Wilson',
  };
